    ...
    *shared_data = START_VALUE;
    ...
    if (pid > 0)
    {
        ...
        for(i=0; i<NUMBER_OPERATION; i++){
            shared_data++;
            shared_data--;
            printf("Value at the end of the operation number %d by the parent: %d\n", i, *shared_data);
        }
    ...
    if (pid == 0)
    {
        ...
        for(i=0; i<NUMBER_OPERATION; i++){
            shared_data++;
            shared_data--;
            printf("Value at the end of the operation number %d by the son: %d\n", i, *shared_data);
        }
